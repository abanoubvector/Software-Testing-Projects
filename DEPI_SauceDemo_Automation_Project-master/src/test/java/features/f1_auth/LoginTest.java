...
public class LoginTest extends BaseTest {
    ...
    public void test_login_with_valid_credentials() throws FileNotFoundException {
        ...
        if (testData[3].equals("valid_credentials")) {
            ...
            BaseTest.validateTestResult(titleText.equals(loginPage.valid_credentials_response), "TestCase ID:DPSAT-T1 - Valid Login");
    ...
    public void test_login_with_inValid_username() throws FileNotFoundException {
        ...
        if (testData[3].equals("invalid_username")) {
            ...
            BaseTest.validateTestResult(errorText.equals(loginPage.invalid_username_response), "TestCase ID:DPSAT-T2 - Invalid Username");
    ...
    public void test_login_with_invalid_password() throws FileNotFoundException {
        ...
        if (testData[3].equals("invalid_password")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.invalid_password_response), "TestCase ID:DPSAT-T3 - Invalid Password");
    ...
    public void testEmptyUsername() throws FileNotFoundException {
        ...
        if (testData[3].equals("empty_username")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.empty_username_response), "TestCase ID:DPSAT-T4 - Empty Username");
    ...
    public void testEmptyPassword() throws FileNotFoundException {
        ...
        if (testData[3].equals("empty_password")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.empty_password_response), "TestCase ID:DPSAT-T5 - Empty Password");
    ...
    public void testEmptyUsernameAndPassword() throws FileNotFoundException {
        ...
        if (testData[3].equals("empty_username_and_password")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.empty_username_and_password_response), "TestCase ID:DPSAT-T6 - Empty Username and Password");
    ...
    public void testLockedOutUser() throws FileNotFoundException {
        ...
        if (testData[3].equals("locked_user")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.locked_user_response), "TestCase ID:DPSAT-T7 - Locked Out User");
    ...
    public void testCaseSensitivityForUsername() throws FileNotFoundException {
        ...
        if (testData[3].equals("username_Case_Sensitivity")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.username_Case_Sensitivity_response), "TestCase ID:DPSAT-T8 - Case Sensitivity on Username");
    ...
    public void testCaseSensitivityForPassword() throws FileNotFoundException {
        ...
        if (testData[3].equals("password_Case_Sensitivity")) {
            loginPage.login(testData[0], testData[1]);
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.password_Case_Sensitivity_response), "TestCase ID:DPSAT-T9 - Case Sensitivity on Password");
    ...
    @Test(priority = 10)
    public void test_SQL_injection_on_login() {
            loginPage.login("' OR '1'='1", "any");
            String errorText = loginPage.getLoginErrorMessage();
            BaseTest.validateTestResult(errorText.equals(loginPage.SQL_injection_response), "TestCase ID:DPSAT-T10 - SQL Injection on Login");
    ...
    public void passwordFieldMasking() {
        ...
        BaseTest.validateTestResult(passwordFieldType.equals(loginPage.password_input_type_response), "TestCase ID:DPSAT-T11 - Password Field Masking");
    ...
    public void navigate_to_inventory_without_credentials()  {
        ...
        BaseTest.validateTestResult(errorText.equals(loginPage.navigate_to_inventory_without_credentials_response), "TestCase ID:DPSAT-T12 - Accessing 'inventory.html' when logged out");
